    ...
    then
        ...
        sglang serve \
            ...
            --speculative-draft-model-quantization unquant \
	          --enable-hierarchical-cache --hicache-io-backend kernel_ascend --enable-cache-report --hicache-ratio 4.0 \
            --hicache-storage-backend ascend_memcache \
            --hicache-storage-backend-extra-config '{"meta_service_url":"tcp://192.168.25.209:5000", "config_store_url":"tcp://192.168.25.209:6000", "log_level":"info", "world_size":256, "protocol": "device_sdma", "prefetch_threshold": 1, "dram_size": "3GB"}' \
